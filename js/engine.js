...
var Engine = (function(global) {
    ...
    /* 这个函数检查过马路时是否撞车,如果撞车,则reset game.
     * 函数遍历所有的enemies, 判断每个enemy是否和player碰撞
     */
    function checkCollisions(){
    	...
    	allEnemies.forEach(function(enemy) {
    		...
    		var width2 = 101;
    		var height2 = 70;
    		// 判断2个方块是否部分重叠，2个方块x方向距离差<方块x方向和的一半，并且y方向距离差<方块y方向和的一半 
    		if(2 * Math.abs(x1 - x2) < (width1 + width2 -30) && 2 * Math.abs(y1 - y2) < height1 + height2)
    		{
    			// 碰撞到了
    			isCollision = true;
    		}
    ...
    /* 这个函数检查是否成功穿过马路,如果成功穿过马路的话,重新设定enemy和player
     * 并且score+=1
     */
